...
class C_Api extends Controller
{
    ...
    {
        // data kegiatan 
        $dataKegiatan = M_Kegiatan::where('token_kegiatan', $idKegiatan) -> first();
        // data peserta 
        $dataPeserta = M_Peserta::where('id_kegiatan', $idKegiatan) -> get();
        $dr = ['idKegiatan' => $idKegiatan, 'dataKegiatan' => $dataKegiatan, 'dataPeserta' => $dataPeserta];
        $pdf = PDF::loadview('admin.mainApp.export.laporanAntrianMentor', $dr);
