...
<head>
    ...
    <title>Aplikasi Monitoring Ibadah Al - Izzah Uinsu</title>
    <!-- Icons-->
...
<body class="app header-fixed sidebar-fixed aside-menu-fixed sidebar-lg-show">
    <header class="app-header navbar">
        ...
        <a class="navbar-brand" href="javascript:void(0)">
            <img class="navbar-brand-full" src="http://s3.jagoanstorage.com/aditia-storage/asset/logo/LOGO_LDK.jpg" width="49" alt="Uinsu Logo">
        </a>
