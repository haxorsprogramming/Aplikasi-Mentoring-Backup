      ...
      <div class="card">
        ...
        <div class="card-body">
          <div style="text-align: center;">
            ...
            <div class="row">
              <div class="col-6">
              <img src="http://s3.jagoanstorage.com/aditia-storage/asset/logo/pic_1.jpg" style="width: 90%;border-radius:20px;">
              </div>
              <div class="col-6">
              <img src="http://s3.jagoanstorage.com/aditia-storage/asset/logo/pic_2.jpg" style="width: 90%;border-radius:20px;">
              </div>
            </div>
